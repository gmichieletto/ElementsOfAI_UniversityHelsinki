...
def main(X_train, X_test, y_train, y_test):
    ...
    for i, test_item in enumerate(X_test):
        ...
        # add your code here
        nearest= np.argsort(distances)[:3]      # this just finds the nearest neighbour (so k=1)
        ...
        y_predict[i] = stats.mode(y_train[nearest])[0]          # this just classifies everything as 0, edit it
